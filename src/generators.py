from typing import Dict, Iterable, Generator, Any
...
def card_number_generator(start: int=0, end: int=9999999999999999) -> Generator:
    ...
    if not str(start).isdigit() or not str(end).isdigit() or start < 0 or end < 0 or start > 9999999999999999 or end > 9999999999999999:
    ...
    while start <= end:
        ...
        number_card = f'{number_card_without_spaces[:4]} {number_card_without_spaces[4:8]} {number_card_without_spaces[8:12]} {number_card_without_spaces[12:]}'
        yield number_card
        start += 1
